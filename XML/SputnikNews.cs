...
namespace TelegramBot.XML
{
    ...
    public class SputnikNews
    {
        ChatSendMessage chatSendMessage = new ChatSendMessage();
        XmlDocument xDoc = new XmlDocument();
        public void GetNews(int chatID)
        {
            List<SputnikNewsN.Items> items = new List<SputnikNewsN.Items>();
            xDoc.Load("https://sputniknews.com/export/rss2/world/index.xml");
            ...
            foreach (XmlNode xnode in xRoot)
            {
                ...
                {
                    SputnikNewsN.Items item = new SputnikNewsN.Items();
